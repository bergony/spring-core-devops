...
CREATE USER 'loginqa2'@'localhost' IDENTIFIED BY 'guru';

GRANT SELECT ON qa2.* to 'loginqa2'@'localhost';
GRANT INSERT ON qa2.* to 'loginqa2'@'localhost';
GRANT DELETE ON qa2.* to 'loginqa2'@'localhost';
GRANT UPDATE ON qa2.* to 'loginqa2'@'localhost';
GRANT CREATE ON qa2.* to 'loginqa2'@'localhost';